...
二进制：它由两个基本字符0，1组成，二进制代码运算规律是逢二进一。***从右到左开始计算(从低位到高位计算【高位0000 0000低位】),1字节不足八位则左侧补位0，不补就是简写.***
...
上位机开发核心环节：设备通信。***在了解基础应用的前提下，学习通信本质，深入通信协议，打通协议定制之路。***
